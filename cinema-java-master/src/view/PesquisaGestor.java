...
/**
 * Esta classe é responsável pela interface de pesquisa de gestores.
 */
public class PesquisaGestor extends javax.swing.JDialog {

    private Resposta rp;
    private String msg;
    
    /**
     * Creates new form PesquisaGestor
     */
    public PesquisaGestor(java.awt.Frame parent, boolean modal, Resposta rp) {
        super(parent, modal);
        initComponents();
        ...
        jTableGestores.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent lse) {
                msg = jTableGestores.getValueAt(jTableGestores.getSelectedRow(), 0).toString();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Pesquisar Gestor");
        ...
        jTableGestores.setFont(new java.awt.Font("Segoe UI", 0, 12)); // NOI18N
        jTableGestores.setModel(ControlePessoa.updateTableGestores());
        jTableGestores.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PesquisaGestor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PesquisaGestor dialog = new PesquisaGestor(new javax.swing.JFrame(), true, null);
